...
export const VILLES_CONTENU: Record<string, VilleContenu> = {
  ...
  bouglainval: {
    ...
    ctaTexte:
      "Plutôt qu'un devis à distance, M. Renaud préfère venir voir : il se déplace rapidement à Bouglainval, examine la toiture et vous explique précisément ce qu'elle demande. Quinze années d'expérience des travaux de couverture, un savoir-faire familial, et un chiffrage gratuit remis après la visite.",
